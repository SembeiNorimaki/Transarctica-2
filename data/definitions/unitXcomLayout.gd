...
const atlas = {
    "torso": {
        "IdleState": aux.TorsoIdle,
        "MoveState": aux.TorsoIdle,
        "AimState": aux.TorsoIdle,
        "CrouchState": aux.TorsoIdle
    },
    "legs": {
        "IdleState": aux.LegsIdle,
        "AimState": aux.LegsIdle,
        "MoveState": aux.LegsMove,
        "CrouchState": aux.LegsCrouch
    },
    "left_arm": {
        "IdleState": aux.LeftArmHoldWeapon,
        "AimState": aux.LeftArmHoldWeapon,
        "MoveState": aux.LeftArmHoldWeapon,
        "CrouchState": aux.LeftArmHoldWeapon
    },
    "right_arm": {
        "IdleState": aux.RightArmHoldWeapon,
        "AimState": aux.RightArmAim,
        "MoveState": aux.RightArmHoldWeapon,
        "CrouchState": aux.RightArmHoldWeapon
    },
    "dead_part": {
        "IdleState": aux.Dead,
        "AimState": aux.Dead,
        "MoveState": aux.Dead,
        "CrouchState": aux.Dead
    }
}
